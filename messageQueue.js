...
class MessageQueue extends EventEmitter {
  constructor(waService, io) {
    ...
    this.io = io;
    this.logger = createChildLogger('messageQueue');
  ...
  async _processNext() {
    ...
    if (!isBusinessHours()) {
      this.logger.info('Fora do horário comercial (08h–20h). Fila pausada até as 08:00.');
    ...
    try {
      ...
      this.logger.error({ err: err.message, phone: pending.phone, id: pending.id }, 'Erro ao enviar mensagem');
